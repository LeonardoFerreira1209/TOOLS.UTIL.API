...
public class TwillioService : ITwillioService
{
    ...
    public async Task<ApiResponse<object>> Sms(MessageRequest request)
    {
        ...
        try
        {
            ...
            var message = MessageResource.Create(body: request.Content, from: new Twilio.Types.PhoneNumber(_appsettings.Value.Twillio.TwillioPhoneNumber),  to: new Twilio.Types.PhoneNumber(request.PhoneNumber));
